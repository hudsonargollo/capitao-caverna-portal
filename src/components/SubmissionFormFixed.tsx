    ...
    <form onSubmit={onSubmit} className="w-full">
      ...
      <div className="mt-6 flex justify-center">
        <Button
          ...
          disabled={(!file && !isTestMode) || (!testQuestion.trim() && isTestMode) || !consent || isLoading}
        >
          {isLoading ? "Processando..." : (isTestMode ? "Testar Resposta" : "Enviar Pergunta")}
        </Button>
      </div>
    </form>
  );
...
export default SubmissionFormFixed;
